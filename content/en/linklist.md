...
- [Fawkes](https://sandlab.cs.uchicago.edu/fawkes/): A tool to cloack your personal pictures, read more in this [Master's prez](https://homepages.staff.os3.nl/~delaat/rp/2020-2021/p56/presentation.pdf))
...
- [Blockchair](http://blkchairbknpn73cfjhevhla7rkp4ed5gg2knctvv7it4lioy22defid.onion/): If you really can't self-host a block explorer, use this one over Tor
...
- [Wordsafety](http://wordsafety.com/): Check a name for unwanted meaning in 19+ languages
...
- [ATT&CK](https://attack.mitre.org/): The ATT&CK matrix, no need for presentation anymore
- [RE&CT](https://github.com/atc-project/atc-react): Equivalent of the ATT&CK matrix for the defensive (blue team) side.
- [D3FEND](https://d3fend.mitre.org/): Official ATT&CK defensive equivalent from the MITRE organization
- [Sim3 OpenCSIRT](https://sim3-check.opencsirt.org/#/) Online tool to assess a CSIRT capabilities.
- [VECTR](https://github.com/securityriskadvisors/vectr): Tool to facilitate the tracking of red and blue team testing.
- [Uncoder](https://uncoder.io/): Online tool to convert SIEM/EDR detection rules accros various formats.
...
- [Caravan](https://unchained-capital.github.io/caravan/): Open-source tool to manage Bitcoin multi-sig transactions
- [MicroStrategy Bitcoin Strategy](https://www.microstrategy.com/en/hyperintelligence/asset-vs-btc): See how Bitcoin performed compare to many other asset types
- [BitcoinWisdom](https://bitcoinwisdom.io/): Track the performance of Bitcoin and other cryptocurrencies.
- [LN.Guide](https://bitcoiner.guide/lightning/): Extensive guide on the Bitcoin lightning network
...
- [Revoke](https://revoke.cash/): Allow to revoke an address participation to a smart contract (As long as you own the private key)
- [DeFi Pulse](https://defipulse.com/): Best resource to learn more about a DeFi protocol
- [StackingEther](https://stakingether.com/): Analyze of the Ethereum2.0 PoS network
- [DaiStats](https://daistats.com/#/): Statistics from the Dai decentralized stablecoin network
...
- [Staking Rewards](https://www.stakingrewards.com/): Analyze top staking cryptocurrencies project by reward
...
- [Keyboard Layout Editor](http://www.keyboard-layout-editor.com/): All is in the name
- [Keyboard Firmware Builder](https://kbfirmware.com/): Also all in the name, to be used with the above tool
